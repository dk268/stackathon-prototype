...
let counter = 0;
function createData(name, characterName, isAlt) {
  counter += 1;
  return { id: counter, name, characterName, isAlt };
}
...
class AllCharacters extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      orderBy: "name",
      selected: [],
      data: this.props.allCharacters
        .map(character =>
          createData(character.characterName, character.dkp, character.isAlt)
        )
        .sort((a, b) => (a.characterName < b.characterName ? -1 : 1)),
      page: 0,
      rowsPerPage: 5,
    };
  }
